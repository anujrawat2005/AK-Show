  ...
  return show ?  (
    ...
    md:pt-50">
      ...
      h-max md:sticky md:top-30">
        ...
        <div className="mt-5 space-y-1">
          {show.dateTime[date].map((item)=>(
            <div key={item.time} onClick={()=>{setSelectedTime(item)}} className={`flex items-center gap-2 px-6 py-2 w-max rounded-e-md
      ...
      <div className="relative flex-1 flex  flex-col items-center max-md:mt-16 ">
        ...
        <button onClick={bookTickets} className="flex items-center gap-1 mt-20

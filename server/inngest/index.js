...
//Ingest fuction to save user data to database
...
// Ingest function to cancel booking and realese seat of shows after 10 minutes of booking created if payment is not made
...
//Ingest Function to send reminder
            ...
            return await Promise.allSettled(
                reminderTasks.map(task =>sendEmail({
                    ...
                    body:`<div style="font-family: Arial, sans-serif; padding: 20px;">
                            ...
                            <br/>
                            <p>Enjoy the show!<br/>AKshow Team</p>
                        </div>`
...
//Ingest function to send notification when new show is added
...
[syncUserCreation,syncUserDeletion,syncUserUpdation,releaseSeatsAndDeleteBooking,sendBookingConfirmationEmail, sendShowReminders];